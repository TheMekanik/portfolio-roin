...
import profilePic from "../assets/ResizedCloseUp.jpeg";
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-justify my-2 max-w-xl motion.py-6 font-light tracking-tighter"
            >
              {language === "en" ? HERO_CONTENT.en : HERO_CONTENT.id}
            </motion.p>
          </div>
        </div>
